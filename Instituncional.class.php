...
public function select() {
    $connection = new DBConnection();
    $sqlCommand = "SELECT (idInstituicao, nome, cpf_cnpj, tipoPessoa, endereco, bairro, cidade, uf, cep, telefone, email, logo) FROM bdlojinha;";
...
public function insert(){
    $connection = new DBConnection();
    $sqlCommand = " INSERT INTO bdlojinha (idInstituicao, nome, cpf_cnpj, tipoPessoa, endereco, bairro, cidade, uf, cep, telefone, email,logo) VALUES 
('$idInstituicao', '$nome', '$cpf_cnpj', '$tipoPessoa', '$endereco', '$bairro', '$cidade', '$uf', '$cep', '$telefone', '$email', '$logo') ";
